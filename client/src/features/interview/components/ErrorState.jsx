...
export default function EmptyState({ onCreate }) {
  return (
    <motion.div
      ...
      className="flex flex-col items-center justify-center rounded-3xl border border-dashed border-[#ECE5EA] bg-gradient-to-b from-white to-[#FAF8FB] px-6 py-14 text-center sm:py-16"
    >
      <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-3xl bg-gradient-to-br from-[#EAA7C4]/40 to-[#970747]/20">
        <FileText size={36} strokeWidth={1.5} className="text-[#970747]" />
      </div>
